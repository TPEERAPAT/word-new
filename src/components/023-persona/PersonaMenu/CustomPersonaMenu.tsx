...
interface CustomPersonaMenuProps {
  display: boolean;
  selectedTags: any[];
...
const CustomPersonaMenu: FC<CustomPersonaMenuProps> = ({
  display,
  selectedTags,
  setSelectedTags,
  tagLibrary,
  ...
  return (
    <div className={`${display ? 'block' : 'hidden'}`}>
      <div className="mb-4 mt-[10px]">{memoizedSelectedTagsRender}</div>
...
export default CustomPersonaMenu;
