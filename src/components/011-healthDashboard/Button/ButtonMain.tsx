...
export default function Main() {
  ...
  return (
    <div className="z-20 ml-6 flex w-[271px] flex-col  items-center">
      <div
        className=" w-full"
        onClick={() => ShowandHide('main')}
        data-testid="main-button-test"
      >
        <ButtonDropdown
      ...
      <div className="mt-2 w-[265px]" data-testid="main-button-list-test">
        <ul
          className={`absolute w-[265px] list-none ${main} rounded-lg bg-white shadow-md transition-all`}
        >
