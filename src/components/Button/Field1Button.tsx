...
export default function Field1Button() {
  ...
  return (
    <div className="flex w-full flex-col items-center">
      <div className="w-full" onClick={() => ShowandHide('dropdown')}>
        <ButtonDropdown name="ทุกจังหวัด" icon={IoCaretDown} />
      </div>

      <div className="mt-2 w-[238px]">
        <ul
          className={` list-none ${dropdown} absolute w-[238px]  rounded-lg bg-white shadow-md transition-all`}
        >
          <li
